...
<div class="konten">
	...
	<form class="form-horizontal" id="form-input" method="post" action="berita_proses.php" enctype="multipart/form-data">
		...
		<input type="hidden" name="kategori" value="iptek" />
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				<a href="?h=iptek"><input type="button" value="Batal" class="btn btn-danger"></a>
			</div>
		</div>
	</form>
	<table id="data" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    	<?php 
                        $x = query("select * from berita where kategori='iptek' order by id_berita desc");
                        ...
                        <tr>
                            ...
                            <td align="center">
                            	<a href="?h=iptek&id=<?php echo $y['id_berita']; ?>" title="edit"><img src="images/edit.png" width="20" height="20" /></a>
                                <a href="berita_proses.php?id=<?php echo $y['id_berita']; ?>&k=iptek" title="hapus" onclick="return confirm('yakin menghapus?')"><img src="images/remove.png" width="20" height="20" /></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
