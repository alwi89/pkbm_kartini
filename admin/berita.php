...
<div class="konten">
	...
	<form class="form-horizontal" id="form-input" method="post" action="berita_proses.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="col-md-3 control-label">Pemilihan Kategori</label>
			<div class="col-md-9">
		...
		<div class="form-group" id="panel-kategori">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input type="text" name="sumber" class="form-control" placeholder="input sumber berita" value="<?php echo isset($b)?$b['sumber']:''; ?>">
			</div>
		</div>
		<div class="form-group">
	...
	<table id="data" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    	<?php 
                        $x = query("select * from berita order by id_berita desc");
                        ...
                        <tr>
                            ...
                            <td align="center">
                            	<a href="?h=berita&id=<?php echo $y['id_berita']; ?>" title="edit"><img src="images/edit.png" width="20" height="20" /></a>
                                <a href="berita_proses.php?id=<?php echo $y['id_berita']; ?>" title="hapus" onclick="return confirm('yakin menghapus?')"><img src="images/remove.png" width="20" height="20" /></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
